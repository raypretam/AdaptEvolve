...
OUTPUT_ROOT = os.path.join(ROOT, "livecodebench_runs_decision_tree_test_run2")
...
def stratified_sample_problems(num_problems: int = 50, random_state: int = 150) -> tuple[List[Dict], List[int]]:
...
def main():
    ...
    # Load dataset using stratified sampling
    try:
        print(f"Loading LiveCodeBench dataset with stratified sampling...")
