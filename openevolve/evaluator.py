...
class Evaluator:
    ...
    async def evaluate_program(
        ...
        program_code: str,
        program_id: str = "",
        test_file_path: os.PathLike = None
    ) -> Dict[str, float]:
        """
        ...
        for attempt in range(self.config.max_retries + 1):
            ...
            try:
                ...
                if self.config.cascade_evaluation:
                    ...
                    result = await self._direct_evaluate(temp_file_path, test_file_path)
    ...
    async def _direct_evaluate(self, program_path: str, test_file_path) -> Dict[str, float]:
        """
        ...
        async def run_evaluation():
            ...
            return await loop.run_in_executor(None, self.evaluate_function, program_path, test_file_path)
    ...
    async def evaluate_multiple(
        ...
        """
        tasks = [
            self.task_pool.create_task(self.evaluate_program, program_code, program_id, test_file_path)
